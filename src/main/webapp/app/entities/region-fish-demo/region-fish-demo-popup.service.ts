...
@Injectable()
export class RegionFishDemoPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.regionModalRef(component, new RegionFishDemo());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    regionModalRef(component: Component, region: RegionFishDemo): NgbModalRef {
