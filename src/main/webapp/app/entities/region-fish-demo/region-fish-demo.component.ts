...
@Component({
    selector: 'jhi-region-fish-demo',
    templateUrl: './region-fish-demo.component.html'
})
export class RegionFishDemoComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/region-fish-demo'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/region-fish-demo', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: RegionFishDemo) {
        return item.id;
    }
