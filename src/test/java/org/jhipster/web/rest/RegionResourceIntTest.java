...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_MAIN_CITY = "AAAAAAAAAA";
    private static final String UPDATED_MAIN_CITY = "BBBBBBBBBB";
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getPostalCode()).isEqualTo(DEFAULT_POSTAL_CODE);
        assertThat(testRegion.getMainCity()).isEqualTo(DEFAULT_MAIN_CITY);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mainCity").value(hasItem(DEFAULT_MAIN_CITY.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.mainCity").value(DEFAULT_MAIN_CITY.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getPostalCode()).isEqualTo(UPDATED_POSTAL_CODE);
        assertThat(testRegion.getMainCity()).isEqualTo(UPDATED_MAIN_CITY);
    }
